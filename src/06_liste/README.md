...
11. Napisati funkciju `rotate :: Int -> [a] -> [a]` koja "rotira" listu tako što svaki element pomera za `n` koraka u levo: `rotate 1 ['a', 'b', 'c', 'd']` daje `['b', 'c', 'd', 'a']`, a `rotate 2 ['a', 'b', 'c', 'd']` daje `['c', 'd', 'a', 'b']`, itd...
